...
const breadth = require('../breadth-first.js');
const Graph = breadth.Graph;
const Vertex = breadth.Vertex;
const Edge = breadth.Edge;
...
describe('Testing breadthFirst method of the Graph', () => {
  ...
  it('Should return null when there node supplied is not in the graph using breadthFirst()', () => {
    const result = test.breadthFirst(ten);
